...
### 문제풀이
  ...
  <p>lock과 key가 겹치도록 아래 그림 크기의 map 2차원 배열을 하나 선언한다.</p>
  <p>크기는 lock.length+key.length*2-2이다.</p>
  <p>저 구간안에서 key를 움직이면서 map배열에 key값을 추가한다.</p>
  <p>lock이 모두 1인 경우가 나오면 true</p>
  <p>4방향을 다 돌려보면서 본다.</p>
  
![image](https://user-images.githubusercontent.com/74286424/231703285-110e5a9b-b517-4b2f-8ba2-be6f8ada02ab.png)

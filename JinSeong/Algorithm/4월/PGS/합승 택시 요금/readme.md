...
### 문제풀이
  ...
  <p>n이 200이기 때문에 아예 모든 구간 거리를 보는 플로이드 워셜 알고리즘을 이용한다.</p>
  <p>먼저 s에서 a로 가는 길과 s에서 b로 가는 길을 answer에 저장한다.</p>
  <p>i가 1부터 n까지 s에서 둘이 같이 i로 가는 길과 i에서 a로 가는 길, i에서 b로 가는 길을 합쳐 최소를 갱신한다.</p>

  ![image](https://user-images.githubusercontent.com/74286424/230805073-eab41a30-8eaf-4c39-8db9-89b3773d545f.png)

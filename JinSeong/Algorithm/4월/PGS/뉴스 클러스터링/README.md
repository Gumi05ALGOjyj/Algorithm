...
<p>우선 알파벳 개수에 맞춰 27*27 배열을 str1, str2 각각 하나씩 만든다</p>
<p>앞에서부터 두 글자씩 자르면서 알파벳인 경우에만 배열에 추가 ex) FR => arr['F'-65]['R'-65]++ </p>
<p>str2도 마찬가지로 진행</p>
<p>이중 포문으로 합집합은 arr[i][j]와 arr2[i][j]의 최댓값, 교집합은 arr[i][j]와 arr2[i][j]의 최솟값으로 각각 더한다</p>
<p>합 집합이 0인 경우는 65536 반환</p>

![image](https://user-images.githubusercontent.com/74286424/234001549-f904c592-3748-4e1e-8e61-20161817ae4d.png)

...
<p>set으로 무슨 종류 있는지 파악</p>
<p>start=0, end=0~gems.length</p>
<p>for문으로 end 돌면서 map에 put(종류, 개수+1) 갱신</p>
<p>map의 gems[start]가 1보다 크면 start 늘려주면서 map의 gems[start]--</p>
<p>map이 모든 보석을 찾았고, 범위가 더 좁혀지면 갱신</p>

![image](https://user-images.githubusercontent.com/74286424/234013318-e7116e98-dd6b-4678-9c73-8cdd55038368.png)

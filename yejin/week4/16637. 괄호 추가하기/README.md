...
#### number[] 배열에 연산에 사용할 정수를 저장한다.
#### operator[] 배열에 연산에 사용할 연산자를 저장한다.
#### termSum[] 배열로 괄호를 생성했을 경우의 부분합을 구해서 저장한다.

#### 괄호가 0개 이상 number_len/2 이하인 경우까지 부분합을 조합으로 구해서 그 경우 연산의 최댓값을 구한다. (이때 연산자는 붙어있을 수 없으므로 재귀로 호출할 때 start = i+2로 설정한다)

![구미_5반-30](https://user-images.githubusercontent.com/81174840/221396049-bee026c0-4c9d-43b1-b65a-d9574a70499e.jpg)
